...
<head>
  ...
  <style type="text/css">
    .hide{display: none;}
    .error{color: red;}
    .user_log ul li a{ color: #59524b !important; }
    sub, sup {
        position: relative;
        font-size: 100%;
        line-height: 0;
  			...
  			<div class="row">
               ...
               <?php if(session('drphllip_user_id')==''){ ?>
                ...
                <?php }else{
                 ...
                 ?>
                 <li><a href="{{url('/cart_list')}}"><i class="fa fa-shopping-cart"></i><sup>{{$cart_count}}</sup></a></li>
                <li>
                  <div class="dropdown user_log">
                    <a href="#" class="dropdown-toggle user_log_click" data-toggle="dropdown">{{$user->fname.' '.$user->lname}}
                    <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      <li><a href="{{url('/profile')}}"><i class="fa fa-user"></i> My Profile</a></li>
                      <li><a href="{{url('/my_order')}}"><i class="fa fa-list"></i> My Orders</a></li>
                      <li><a href="{{url('/my_order?course='.base64_encode('1'))}}"><i class="fa fa-book"></i> My Courses</a></li>
...
<nav class="navbar navbar-expand-md ">
  <a class="navbar-brand" href="{{url('/')}}"><h2>Dr.Philip<strong>Hickman</strong></h2><!-- <img src="images/logo.png"> --></a>
