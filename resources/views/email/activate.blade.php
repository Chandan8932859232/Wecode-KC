                        ...
                        <div style="max-width: 600px; margin: 0 auto; padding: 0 12px;text-align:center;">
                            <div class="card" style="background: white; border-radius: 0.5rem; padding: 2rem; margin-bottom: 1rem;">
                              <!-- <img src="http://itdevelopmentservices.com/makeitpopdetailing/assets/front/images/logo.png" style="width: 85px; margin: 0 215px 12px 215px;"> -->
                                <h2 style="color: #4b6e99; margin: 0 0 12px; line-height: 30px;">You've successfully signed up to WeCode KC.</h2>

                                <p style="margin-bottom: 4rem;">Your WeCode KC Account details.</p>
