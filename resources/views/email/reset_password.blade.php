                    ...
                    <td valign="top">
                        <div style="max-width: 600px; margin: 0 auto; padding: 0 12px;">
                            <div class="card" style="background: white; border-radius: 0.5rem; padding: 2rem; margin-bottom: 1rem;">
                              <!-- <img src="http://itdevelopmentservices.com/makeitpopdetailing/assets/front/images/logo.png" style="width: 85px; margin: 0 215px 12px 215px;"> -->
                                <h2 style="color: #4b6e99; margin: 0 0 12px; line-height: 30px; text-align: center;">Reset Password</h2>

                                <p style="margin-bottom: 2rem; margin-top: 2rem;"><b>Hi <?php echo $name; ?>,</b></p>
                                <p>You recently requested to reset your password for your WeCode KC account!. Click the button below to reset it. </p>
                                <div style="text-align: center; margin-bottom: 2rem;">
                                  <a href="<?php echo $url; ?>" style="border: 1px solid #b3304e;padding: 10px;background: #b3304e;color: #fff;">Reset your password</a>
                                </div>
                    ...
                    <td valign="top" align="center">
                        <div style="max-width: 600px; margin: 0 auto;">
                            <p class="footer_address" style="margin-top: 16px; font-size: 12px; line-height: 20px;">
                                <a href="{{url('/'; ?>" style="font-weight: bold; color: #439fe0;">WeCode KC</a> &nbsp;&bull;&nbsp;
                                <br />
