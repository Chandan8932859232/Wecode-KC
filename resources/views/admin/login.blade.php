                        ...
                        <div class="login-form">
                            <form action="{{url('login')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="email" name="username" placeholder="Email" value="{{$drphilipuser_name}}">
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input class="au-input au-input--full" type="password" name="password" placeholder="Password" value="{{$drphilippassword}}">
                                </div>
                                <div class="login-checkbox">
                                    <label>
                                        <input type="checkbox" name="remember_me" class="remember_me" <?php if($drphiliprem==1){ echo "checked"; } ?> value="1">Remember Me
                                    </label>
                                    <!-- <label>
