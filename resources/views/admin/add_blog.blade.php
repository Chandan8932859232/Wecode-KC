                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="heading" class="form-control heading" placeholder="Blog Heading" value="<?php if(isset($_GET['key'])){ echo $blog->blog_heading; }?>">
                        </div>

                        <div class="form-group">
                          <label>Content:</label>
                          <textarea class="form-control content_text" name="content_text" id="content_text" rows="10" placeholder="Content"><?php if(isset($_GET['key'])){ echo $blog->content; }?></textarea>
                        </div>
                        <div class="form-group">
                          <label>Blog Image: <span class="image-error error"></span></label>
                          <input type="file" name="blog_image" class="form-control blog_image" placeholder="Blog Image">
                        </div>
                        <?php if(isset($_GET['key'])){ ?>
                        <div class="form-group">

                            <img src="{{url('public/upload/blog_image/'.$blog->blog_image)}}" width="100px" height="100px">
                      ...
                      <?php } ?>
                        ...
                        <div class="form-group text-center">
                          <?php if(isset($_GET['key'])){ ?>
                            ...
                            <input type="hidden" name="blogimg" class="blogimg" value="{{$blog->blog_image}}">
